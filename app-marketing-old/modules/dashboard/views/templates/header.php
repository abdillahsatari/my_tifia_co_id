...
<head>
    ...
    <link href="<?= base_url() ?>assets/demo/demo11/base/custom-chat.css" rel="stylesheet" type="text/css" />
    ...
    <link rel="shortcut icon" href="<?= base_url() ?>assets/demo/demo11/media/img/logo/favicon.ico" />
