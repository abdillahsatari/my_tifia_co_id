...
if (!function_exists('send_mailer')) {
    ...
    function send_mailer($data = "")
    {
        if ($data != "") {
            ...
            // $mail->AddEmbeddedImage('assets/hyper/images/black1.png', 'logo ', 'black.png');
            $mail->AddEmbeddedImage('assets/hyper/images/black1.png', 'logoimg', 'black.png', 'base64', 'image/png');
...
//            $mail->SMTPAuth = true;
//            $mail->Username = 'email_testing@tifia.co.id';
//            $mail->Password = 'ema1lTesting@tifia2022';
