...
class Withdrawal_terbayar_model extends CI_Model
{
    function get_all()
    {
        ...
        // $this->db->where("(marketing_withdrawal.status='Approved' OR marketing_withdrawal.status='Declined')");
        $this->db->where("marketing_withdrawal.status='Approved'");
