        ...
        <div class="col-xs-12 col-md-6">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?= $button;?> Nasabah</h3>
        ...
        <div class="col-xs-12 col-md-6">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <br>
                    <div class="form-group">
                        <label for="dokumen_tambahan">Foto NPWP <?php echo form_error('foto_npwp') ?></label><p>
                        <img src="<?= base_url() ?>uploads/photo/<?= $foto_npwp ?>" width='50%'>
                        <input type="file" class="form-control" name="foto_npwp" id="foto_npwp">
                    </div>
                    <div class="form-group">
                        <label for="foto_terkini">Foto Terkini <?php echo form_error('foto_terkini') ?></label><p>
                        <img width="50%" src="<?= base_url() ?>uploads/photo/<?= $foto_terkini ?>">
                        <input type="file" class="form-control" name="foto_terkini" id="foto_terkini">
                    </div>
                    <div class="form-group">
                        <label for="pict_identitas">Pict Identitas <?php echo form_error('pict_identitas') ?></label><p>
                    ...
                    <div class="form-group">
                        <label for="dokumen_tambahan">Scan/foto rekening koran/rekening telpon/buku tabungan <?php echo form_error('foto_buku_tabungan') ?></label><p>
                    ...
                    <?php if ($button!='Create') { ?>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status" id="status">
                                ...
                                <option value="Register" disabled <?php if ($status=='Register') {
                                    echo "selected";
                                } ?>>Register</option>
                                <option value="Complete" <?php if ($status=='Complete') {
                                    echo "selected";
                                } ?>>Complete</option>
                                <option value="Checking" <?php if ($status=='Checking') {
                                    echo "selected";
                                } ?>>Checking</option>
                                <option value="Approved" <?php if ($status=='Approved') {
                                    echo "Approved";
                                } ?>>Approved</option>
                                <option value="Active" disabled <?php if ($status=='Active') {
                                    echo "selected";
                                } ?>>Actived</option>
                            </select>
                        </div>
