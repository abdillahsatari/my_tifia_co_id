            ...
            <table class="table table-bordered table-striped" id="tableku" style="width:100%">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Total Komisi IDR</th>
                  <th class="text-center">Total Lot Terbayar</th>
                  <th class="text-center">Total Komisi Terbayar</th>
                  <th class="text-center">Sisa Komisi Belum Terbayar</th>
