    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">List Withdrawal Request</h3>
                    ...
                    <div class="row" style="margin-bottom: 10px">
                        <div class="col-xs-12 col-md-4">
                            <!-- <div class="btn-group mb-3" role="group">
                                ...
                                <button type="button" class="btn btn-warning btn-sm" id="request_all" data-href="<?= base_url() ?>dashboard/Withdrawal_request/requestAll_action"><i class="fa fa-users"></i> Request All</button>
                            </div> -->
                        </div>
                        ...
                        <div class="col-xs-12 col-md-4 text-right">
                            <?php echo anchor(site_url('adminarea/marketing/Withdrawal_request/excel'), '<i class="fa fa-file-excel"></i> Excel', 'class="btn btn-success"'); ?>
                            <!-- <?php echo anchor(site_url('adminarea/marketing/Withdrawal_request/word'), '<i class="fa fa-file-word"></i> Word', 'class="btn btn-primary"'); ?> -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $(document).ready(function() {
            var dataTable = $('#tableku').DataTable({
                ...
                "order": [],
                "ajax": {
                    url: "<?= base_url() . 'adminarea/marketing/withdrawal_request/fetch_list'; ?>",
                    type: "POST"
                },
                "columnDefs": [{
                    "targets": [0, 1, 2, 3, 5, 6],
