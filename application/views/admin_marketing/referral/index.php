  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">List Sales Referral</h3>
        ...
        <form id="myform" method="post" onsubmit="return false">
          ...
          <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-xs-12 col-md-4 text-right">
              <?php echo anchor(site_url('adminarea/marketing/referral/excel'), '<i class="fa fa-file-excel"></i> Excel', 'class="btn btn-success"'); ?>
            ...
            <table class="table table-bordered table-striped" id="tableku" style="width:100%">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Akun Perdagangan</th>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    $(document).ready(function() {
      var dataTable = $('#tableku').DataTable({
        ...
        "order": [],
        "ajax": {
          url: "<?= base_url() . 'adminarea/marketing/referral/fetch_list'; ?>",
          type: "POST"
        },
        "columnDefs": [{
