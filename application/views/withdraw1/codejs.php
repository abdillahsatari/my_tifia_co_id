<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "withdraw/json", "type": "POST"},
                    columns: [
                         {
                            "data": "withdraw_id",
                            "orderable": false,
                        ...
                        },
                        {
                            "data": "withdraw_id",
                            "orderable": false
                        },{"data": "nasabah_id"},{"data": "no_akun"},{"data": "wallet_id"},{"data": "bank_id"},{"data": "total"},{"data": "status_withdraw"},{"data": "komentar"},{"data": "sumber_withdraw"},{"data": "tanggal_withdraw"},{"data": "kode_withdraw"},
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"
