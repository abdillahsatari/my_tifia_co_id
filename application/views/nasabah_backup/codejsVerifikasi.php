<script type="text/javascript">
    $(document).ready(function() {
        ...
        var t = $("#mytable").DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "Nasabah_list_verifikasi/json", "type": "POST"},
            columns: [
                    {
                    "data": "nasabah_id",
                    "orderable": false,
                ...
                },
                {
                    "data": "nasabah_id",
                    "orderable": false
                },{"data": "nama_lengkap"},{"data": "gender"},{"data": "no_hp"},{"data": "email"},{"data": "status"},{"data": "status_verify"},{"data": "created_date"},
                {
                    "data" : "action",
                    "orderable": false,
                    "className" : "text-center"
