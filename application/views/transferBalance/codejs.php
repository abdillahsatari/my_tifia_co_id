<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "transferbalance/json", "type": "POST"},
                    columns: [
                         {
                            "data": "deposit_id",
                            "orderable": false,
                        ...
                        },
                        {
                            "data": "deposit_id",
                            "orderable": false
                        },{"data": "no_akun"},{"data": "nama_lengkap"},{"data": "email"},{"data": "total"},{"data": "type_deposit"},{"data": "status_deposit"},{"data": "tanggal_deposit"},
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"
