<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "acc_currency/json", "type": "POST"},
                    columns: [
                         {
                            "data": "acc_currency_id",
                            "orderable": false,
                        ...
                        {"data": "nama_currency"},{"data": "deposit_rate"},{"data": "withdraw_rate"},{"data": "status_currency"},
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"
