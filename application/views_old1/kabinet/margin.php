             ...
             <div class="m-content">
                 <div class="m-alert m-alert--icon m-alert--air m-alert--square alert alert-dismissible m--margin-bottom-30" role="alert">
                     ...
                     <div class="m-alert__text">
                         Tabel dibawah ini adalah nasabah yang sudah berhasil di ajak join di kabinet PT. Tifia Finansial Berjangka, perhitungan komisi nya tergantung dari <strong>MARGIN / DEPOSIT</strong> nasabah anda, perhitungan komisi akan dilakukan setiap tanggal 28 dan akan di bagikan dari tanggal 1 s/d tanggal 5
                     </div>
                 </div>
                         ...
                         <div class="m-portlet__head-caption">
                             <div class="m-portlet__head-title">
                                 <h3 class="m-portlet__head-text">
                                     Daftar Referral dan Komisi Berdasarkan Margin Masuk
                                 </h3>
                             </div>
                         </div>
                     </div>
                                     ...
                                     <div class="m-form__section m-form__section--first">
                                         ...
                                         <div class="form-group m-form__group row">
                                             ...
                                             <div class="col-lg-6">
                                                 ...
                                                 <span class="m-form__help">Nominal yang akan anda dapatkan dari hasil komisi margin</span>
                                             </div>
                                         </div>
