<script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "acc_trading/json", "type": "POST"},
                    columns: [
                         {
                            "data": "no_akun",
                            "orderable": false,
                        ...
                        },
                        {
                            "data": "no_akun",
                            "orderable": false
                        },{"data": "no_akun"},{"data": "nama_lengkap"},{"data": "email"},{"data": "type"},{"data": "nama_currency"},{"data": "nama_leverage"},{"data": "tanggal_buat_akun"},{"data": "status_aktif"},
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"
