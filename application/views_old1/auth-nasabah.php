...
<head>
    ...
    <title> Signin | PT. Tifia Finansial Berjangka Official Kabinet</title>
        ...
        <div class="auth-fluid-form-box">
            <div class="align-items-center d-flex h-100">
                <div class="card-body">
                    ...
                    <!-- title-->
                    <h4 class="mt-0">Masuk Kabinet</h4>
                    <p class="text-muted mb-4">Masukan alamat email & password untuk masuk ke kabinet</p>
