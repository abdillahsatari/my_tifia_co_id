			                ...
			                <table class="table table-bordered table-striped" style="width:100%">
			                  	...
			                  	<tbody>
				                    ...
				                    <tr>
				                        ...
				                        <td><a href="<?= base_url() ?>adminarea/perjanjian/formulirpbk06/<?= $acc[0]->no_akun ?>" target="_blank" class="btn btn-warning m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air">
				                                <span>
				                                    <i class="la la-file-pdf-o"></i>
				                                    <span>Lihat</span>
				                                </span>
