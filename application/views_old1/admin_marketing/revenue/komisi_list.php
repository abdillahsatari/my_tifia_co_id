                ...
                <form id="myform" method="post" onsubmit="return false">
                    ...
                    <div class="row" style="margin-bottom: 10px">
                        ...
                        <div class="col-xs-12 col-md-4 text-right">
                            <?php echo anchor(site_url('adminarea/marketing/revenue/excel'), '<i class="fa fa-file-excel"></i> Excel', 'class="btn btn-success"'); ?>
                        ...
                        <table class="table table-bordered table-striped" id="tableku" style="width:100%">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th class="text-center">Akun Trading / Nasabah</th>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $(document).ready(function() {
            var dataTable = $('#tableku').DataTable({
                ...
                "order": [],
                "ajax": {
                    url: "<?= base_url() . 'adminarea/marketing/revenue/fetch_komisi' ?>",
                    type: "POST"
                },
                "columnDefs": [{
                    "targets": [0, 1, 2, 3, 4, 5],
