...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		if (!$this->ion_auth->logged_in())
		{
			...
			redirect('adminarea/login', 'refresh');
		}
		else
		{
			redirect('adminarea/dashboard');
		}
	}
	...
	public function login()
	{
		...
		if ($this->form_validation->run() === TRUE)
		{
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember))
			{
				...
				//redirect them back to the home page login ke halaman dashboard admin
				
				$this->session->set_flashdata('message', $this->ion_auth->messages());
				redirect('adminarea/dashboard', 'refresh');
			}
			else
			{
				...
				redirect('adminarea/login', 'refresh'); // use redirects instead of loading views for compatibility with MY_Controller libraries
			}
		}
		else
		{
