        ...
        <div class="box">
            ...
            <div class="box-body">
                <table class="table">
            	    ...
            	    <tr><td>Bukti Transfer</td><td><img src="<?= base_url() ?>uploads/bukti_tf/<?php echo $bukti_transfer; ?>" width="50%"></td></tr>
            	    <tr><td>Type Deposit</td><td><?php echo $type_deposit; ?></td></tr>
            	    <tr><td>Status Deposit</td><td><?php echo $status_deposit; ?></td></tr>
                    
            	    <tr><td>Tanggal Deposit</td><td><?php echo $tanggal_deposit; ?></td></tr>
