...
<html lang="en">
    ...
    <head>
        ...
        <title>PT. Tifia Finansial Berjangka | Official Website</title>
                ...
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                       ...
                       <div class="auth-brand text-center text-lg-left">
                            <a href="#">
                                <span><img style="max-height: 60px;" src="assets/hyper/images/black.svg" alt="PT. Tifia Finansial Berjangka"></span>
                            </a>
                        </div>
