...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= base_url();?>" class="logo">
      ...
      <span class="logo-lg"><img alt="tfx Markets Limited" style="width: 50%;" src="<?= base_url('assets/demo/demo11/media/img/logo/black.svg'); ?>  "></span></center>
    </a>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
             <!--  <img src="<?= base_url('assets/dist/img/user2-160x160.jpg" class="user-image" alt="U');?>ser Image"> -->
              <span class="hidden-xs">Selamat Datang! <?= $user->first_name;?>&nbsp;<?= $user->last_name;?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?= base_url();?>auth/change_password" class="btn btn-default btn-flat">Profile</a>
                </div>
