                ...
                <div class="m-portlet__body">
                    ...
                    <div class="m-section">
                        ...
                        <table class="table">
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>: <?php echo $nasabah->tempat_lahir; ?> / <?= date("d F Y", strtotime($nasabah->tgl_lahir)) ?>  </td>
                                </tr>
                                <tr>
                                    <td>Alamat Rumah</td>
                        ...
                        <br><br><br>
                            ...
                            <p align="center">Menerima pada Tanggal <?= date("d F Y", strtotime($acc_account[0]->tanggal_buat_akun)) ?></p>
