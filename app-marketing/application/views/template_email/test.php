...
<head>
   ...
   <title>PT. Tifia Finansial Berjangka | Official Mail</title>
                        ...
                        <tr>
                           <td align="left" valign="top">
                              ...
                              <div style="height: 73px; line-height: 73px; font-size: 71px;">
                                 <img style="height: 60px; display: block; margin-left: auto; margin-right: auto;" alt="" src="cid:logoimg">
                              </div>
                           </td>
                        </tr>
                     </table>
                        ...
                        <tr>
                           <td align="left" valign="top">
                              <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
                                 <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif;color: #1a1a1a;font-size: 36px;line-height: 60px;font-weight: 300;letter-spacing: -1.5px;">Hey Dedi,</span>
                              </font>
                              ...
                              <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 18px; line-height: 32px;">
                                 <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 18px; line-height: 32px;">Hai dedi.ap@gmail.com sebelum anda menggunakan layanan kabinet PT. Tifia Finansial Berjangka, silahkan verifikasi akun email! Setelah berhasil verifikasi silahkan login dengan menggunakan email dan password pada saat anda mendaftar</span>
                              </font>
                                    ...
                                    <td align="center" valign="top">
                                       <table cellpadding="0" cellspacing="0" border="0" width="78%" style="min-width: 300px;">
                                          <tr>
                                             ...
                                             <td align="center" valign="top" width="23%">
                                                <a href="https://tfx.co.id/kabinet" target="_blank" style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">
                                                   <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">
