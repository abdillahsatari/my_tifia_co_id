                                ...
                                <tr>
                                    <td align="left" valign="top">
                                        <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
                                            <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif;color: #1a1a1a;font-size: 36px;line-height: 60px;font-weight: 300;letter-spacing: -1.5px;"><?= $judul; ?></span>
                                        </font>
                                            ...
                                            <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 18px; line-height: 32px;">
                                                ...
                                                <table id="credentials">
                                                    <tr>
                                                        <td>status</td>
                                                        <td>:</td>
                                                        <td><?= $data['status_withdraw'] == "Done" ? "Approve" : $data['status_withdraw']; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>No Akun</td>
                                                        <td>:</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td><?= date_tampil($data['tanggal_konfirmasi']) ?></td>
                                                    </tr>
