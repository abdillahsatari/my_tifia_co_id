...
<div class="left-side-menu left-side-menu-light">
    ...
    <div class="slimscroll-menu" id="left-side-menu-container">
        ...
        <a href="index.html" class="logo text-center">
            <span class="logo-lg">
                 <img src="assets/hyper/images//logo-dark.png" alt="" height="16">
            </span>
            <span class="logo-sm">
                 <img src="assets/hyper/images//logo_sm.png" alt="" height="16">
            </span>
        </a>
        ...
        <ul class="metismenu side-nav side-nav-light">
            ...
            <li class="side-nav-item">
                ...
                <ul class="side-nav-second-level" aria-expanded="false">
                    ...
                    <li>
                        <a href="layouts-dark-sidenav.html">Dark Sidenav</a>
                    </li>
                    <li>
        ...
        <div class="help-box text-white text-center">
            <a href="javascript: void(0);" class="float-right close-btn text-white">
             ...
             <img src="assets/hyper/images//help-icon.svg" height="90" alt="Helper Icon Image" />
