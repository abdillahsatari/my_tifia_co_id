                    ...
                    <div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
                        <div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
                            <span class="m-footer__copyright">
                                <?php echo date('Y'); ?> &copy; PT. Tifia Finansial Berjangka <a href="https://tfx.co.id" class="m-link">Official Kabinet Website</a>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <script type="text/javascript" src="<?= base_url() ?>assets/vendors/jquery.min.js"></script>
            ...
            <script src="<?= base_url() ?>assets/demo/default/custom/crud/wizard/wizard.js" type="text/javascript"></script>
            <script src="<?= base_url() ?>assets/demo/default/custom/crud/forms/widgets/bootstrap-maxlength.js" type="text/javascript"></script>
            ...
            <!-- custom -->
            <script src="<?= base_url() ?>assets/vendors/custom/jquery-toast-plugin/jquery.toast.min.js" type="text/javascript"></script>
            <script src="<?= base_url() ?>assets/vendors/custom/sweetalert2/sweetalert2.min.js" type="text/javascript"></script>

            <script src="<?= base_url() ?>assets/demo/default/custom/crud/forms/widgets/summernote.js" type="text/javascript"></script>
            <!--begin::Page Scripts -->
            <script src="<?= base_url() ?>assets/app/js/dashboard.js" type="text/javascript"></script>
            <script src="<?= base_url() ?>assets/bank.js" type="text/javascript"></script>
            <!-- <script src="<?= base_url() ?>assets/acctrading.js" type="text/javascript"></script> -->
            <!-- <script src="<?= base_url() ?>assets/registercomplete.js" type="text/javascript"></script> -->
            <script src="<?= base_url() ?>assets/statuskawin.js" type="text/javascript"></script>
            <!-- WhatsHelp.io widget -->
            <!-- <script type="text/javascript">
            (function () {
            var options = {
            whatsapp: "+6287885355577", // WhatsApp number
            call_to_action: "Halo Admin' Saya Mau Konfirmasi!", // Call to action
            ...
            <script type="text/javascript">
                ...
                //     function() {
                //         $('#loadakuntrading').load('akuntrading/test').fadeIn("slow");
                //     }, 60000); // refresh setiap 10000 milliseconds
            </script>
            <!-- end script JS Pernyataan -->
            <!--end::Page Scripts -->
            </body>
