...
<head>
  ...
  <title>PT. Tifia Finansial Berjangka</title>
...
<body class="sidebar-mini hold-transition fixed skin-purple">
  <!-- Site wrapper -->
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="#" class="logo" style="    background-color: #FFFFFF;">
        ...
        <img alt="tfx Markets Limited" style="width: 80%;" src="<?= base_url('assets/demo/demo11/media/img/logo/black.svg'); ?>  ">
      </a>
      ...
      <nav class="navbar navbar-static-top" style="background-color: #222d32;">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <!-- begin nasabah notification -->
            <li class="dropdown notifications-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                <i class="fa fa-users text-aqua"></i>
                <span class="label label-danger" id="notif-nasabah-badge"></span>
              </a>
              <ul class="dropdown-menu">
                <li class="header" id="notif-nasabah-header"></li>
                <li>
                  <!-- inner menu: contains the actual data -->
                  <ul class="menu" id="notif-nasabah-list">
                  </ul>
                </li>
                <!-- <li class="footer"><a href="#">View all</a></li> -->
              </ul>
            </li>
            <!-- end nasabah notification  -->

            <!-- begin marketing notification -->
            <li class="dropdown notifications-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                <i class="fa fa-id-card text-aqua"></i>
                <span class="label label-danger" id="notif-marketing-badge"></span>
              </a>
              <ul class="dropdown-menu">
                <li class="header" id="notif-marketing-header"></li>
                <li>
                  <!-- inner menu: contains the actual data -->
                  <ul class="menu" id="notif-marketing-list">
                  </ul>
                </li>
                <!-- <li class="footer"><a href="#">View all</a></li> -->
              </ul>
            </li>
            <!-- end marketing notification  -->
                ...
                $(document).ready(function() {
                  ...
                  $.ajax({
                    ...
                    success: function(response, status, jqXHR) {
                      $('#notif-nasabah-list').html(response.list);
                      $('#notif-nasabah-badge').html(response.count);
                      $('#notif-nasabah-header').html(response.count + ' nasabah notifications');
                    }
                  });

                  $.ajax({
                    type: 'GET',
                    url: '<?= base_url('adminarea/notifikasi/getAllNotifMarketing') ?>',
                    success: function(response, status, jqXHR) {
                      $('#notif-marketing-list').html(response.list);
                      $('#notif-marketing-badge').html(response.count);
                      $('#notif-marketing-header').html(response.count + ' marketing notifications');
                    }
                  });
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
               <img  style="width: 14%;" src="<?= base_url('assets/demo/demo11/media/img/logo/favicon1.ico'); ?>  " >
                <span class="hidden-xs"><?= $user->first_name; ?>&nbsp;<?= $user->last_name; ?></span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img  src="<?= base_url('assets/demo/demo11/media/img/logo/favicon1.ico'); ?>  ">
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img style="    border-radius: 8px;" src="<?= base_url('assets/demo/demo11/media/img/logo/favicon1.ico'); ?>  ">
          </div>
