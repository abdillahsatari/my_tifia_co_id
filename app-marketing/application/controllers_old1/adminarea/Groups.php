...
class Groups extends CI_Controller
{
    ...
    public function read($id) 
    {
        ...
        $this->load->view('template/backend', $data);
            ...
            redirect(site_url('adminarea/groups'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('adminarea/groups/create_action'),
	    'id' => set_value('id'),
	    'name' => set_value('name'),
    ...
    public function printdoc(){
        ...
        $this->load->view('adminarea/groups/groups_print', $data);
    }
    ...
    public function word()
    {
        ...
        $this->load->view('adminarea/groups/groups_doc',$data);
    }
