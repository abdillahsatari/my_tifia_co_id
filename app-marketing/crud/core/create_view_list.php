    ...
    <div class=\"box\">
      ...
      <div class=\"box-body\">
        <div class=\"row\" style=\"margin-bottom: 10px\">
            <div class=\"col-md-4\">
                <?php echo anchor(site_url('adminarea/".$c_url."/create'),'<i class=\"fa fa-plus\"></i> Create', 'class=\"btn bg-purple\"'); ?>
            </div>
...
$string .= "\n\t\t\t<td style=\"text-align:center\" width=\"200px\">"
        . "\n\t\t\t\t<?php "
        . "\n\t\t\t\techo anchor(site_url('adminarea/".$c_url."/read/'.$".$c_url."->".$pk."),'<i class=\"fa fa-search\"></i>', 'class=\"btn btn-xs btn-primary\"  data-toggle=\"tooltip\" title=\"Detail\"'); "
        . "\n\t\t\t\techo ' '; "
        . "\n\t\t\t\techo anchor(site_url('adminarea/".$c_url."/update/'.$".$c_url."->".$pk."),' <i class=\"fa fa-edit\"></i>', 'class=\"btn btn-xs btn-warning\" data-toggle=\"tooltip\" title=\"Edit\"'); "
        . "\n\t\t\t\techo ' '; "
        . "\n\t\t\t\techo anchor(site_url('adminarea/".$c_url."/delete/'.$".$c_url."->".$pk."),' <i class=\"fa fa-trash\"></i>','class=\"btn btn-xs btn-danger\" onclick=\"javasciprt: return confirmdelete(\'".$c_url."/delete/'.$".$c_url."->".$pk.".'\')\"  data-toggle=\"tooltip\" title=\"Delete\" '); "
        . "\n\t\t\t\t?>"
        . "\n\t\t\t</td>";
