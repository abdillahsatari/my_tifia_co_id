...
$string .= "\n\t    );
    ...
    public function create() 
    {
        \$data = array(
            'button' => 'Create',
            'action' => site_url('adminarea/$c_url/create_action'),";
foreach ($all as $row) {
...
$string .= "\n\t    );
        ...
        if(!$isai){
            ...
            redirect(site_url('adminarea/$c_url'));
            }else{
                \$this->create();
    ...
    public function update(\$id) 
    {
        ...
        if (\$row) {
            \$data = array(
                'button' => 'Update',
                'action' => site_url('adminarea/$c_url/update_action'),";
foreach ($all as $row) {
...
$hasil_controller = createFile($string, $target . "controllers/adminarea/" . $c_file);
